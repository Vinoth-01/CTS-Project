...
document.querySelectorAll('.faq-box').forEach(function(faqBox) {
  faqBox.addEventListener('click', function() {
    ...
    if (answer.classList.contains('expanded')) {
      ...
      answer.style.maxHeight = answer.scrollHeight + '80px'; // Set to content's height
      answer.style.padding = '15px'; // Adjust padding as needed
    }
  });
});
